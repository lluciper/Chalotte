...
class SalomonBottomBarNew extends StatelessWidget {
  ...
  final List<SalomonBottomBarNewItem> items;
...
/// A tab to display in a [SalomonBottomBarNew]
class SalomonBottomBarNewItem {
